...
Optimized for deployment (loads prebuilt assets instead of rebuilding).
"""
...
def _get_clients():
    ...
    hf_key = st.secrets.get("HF_TOKEN", os.getenv("HF_TOKEN", ""))
...
def _last_score(pattern: str, text: str):
